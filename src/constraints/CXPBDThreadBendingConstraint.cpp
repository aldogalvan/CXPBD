...
#include "CXPBDThreadBendingConstraint.h"

cXPBDThreadBendingConstraint::scalar_type
cXPBDThreadBendingConstraint::evaluate(positions_type const& p, masses_type const& M) const
{
...
void cXPBDThreadBendingConstraint::project(
        positions_type& p,
        positions_type& p0_,
        masses_type const& M,
