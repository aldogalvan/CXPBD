...
void meshObject::createTetrahedralMesh(float scale)
{
    ...
    // TetGen switches
    char TETGEN_SWITCHES[] = "pq1.414a0.005";
...
void VolumeConstraint::computeGraph(MatrixXi E)
{
    ...
    Matrix<int,Dynamic,Dynamic,RowMajor> G(maxpool,maxcolor);
    G.fill(-1);
    ...
    std::cout << "GRAPH TETRAHEDRA: " << maxcolor << " , " << maxpool << std::endl;
...
void EdgeConstraint::computeGraph(MatrixXi E)
{
    ...
    std::cout << "GRAPH EDGES: " << maxcolor << " , " << maxpool << std::endl;
